...
var ManagerAreas = /** @class */ (function (_super) {
    __extends(ManagerAreas, _super);
    function ManagerAreas(props) {
    ...
    ManagerAreas.prototype.componentDidMount = function () {
        var _this = this;
        this.getItems().then(function (response) {
            ...
            _this.setState({ ManagerAreasData: data });
        });
    };
    ManagerAreas.prototype.render = function () {
        return (
        // <div className={ styles.managerAreas }>
        //   <div className={ styles.container }>
        React.createElement("section", { className: "sec-color pt-5 pb-3" },
            React.createElement("div", { className: "container" },
                React.createElement("div", { className: "row pb-5 mt-5" }, this.state.ManagerAreasData.map(function (item) {
                    if (item.Link != '') {
                        return (React.createElement("div", { className: "col-lg-4 text-center pb-4" },
                            React.createElement("a", { href: item.Link, className: "customlink" },
                                React.createElement("div", { className: "box-bg2 p-4 pt-5 pb-5" },
                                    React.createElement("img", { src: item.Image, width: "63" }),
                                    React.createElement("p", { className: "box-p fontBold mt-3" },
                                        React.createElement("b", null, item.Heading)),
                                    React.createElement("p", { className: "fontRegular mt-3" }, item.DescriptionText)))));
                    }
                    else {
                        return (React.createElement("div", { className: "col-lg-4 text-center pb-4" },
                            React.createElement("div", { className: "box-bg2 p-4 pt-5 pb-5" },
    ...
    ManagerAreas.prototype.getItems = function () {
        try {
...
export default ManagerAreas;
//# sourceMappingURL=ManagerAreas.js.map